...
class TestRunOneSku(unittest.TestCase):
    ...
    def _make_sku_input(self):
        ...
        from pipeline.orchestrator import set_test_invariants
        ...
        from pipeline.orchestrator import REQUIRED_PRELOAD_KEYS
        preloaded_data = {
    ...
    def test_run_one_sku_returns_status_and_confidence(self):
        from pipeline.orchestrator import run_one_sku
