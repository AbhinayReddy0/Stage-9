...
def _insert_canonical_sku(cur, tenant_id: str, sku_uuid: str, code: str,
    ...
    cur.execute(
        """
        INSERT INTO public.canonical_sku
...
def _insert_demand_history(cur, tenant_id: str, sku_uuid: str, df: pd.DataFrame):
    """No-op since stage8.demand_history is a derived view over clean_orders.
    The earlier _insert_clean_orders call already populates the view —
    inserting into the view directly fails because column renames make it
    non-updatable."""
    return
