...
Task Reference: TASK_SubStage_9_1_ModelInit.md
Technical Context: Part 5 Sub-Stage 9.1.
"""
...
def run_model_initialisation(
    ...
    sku_meta    = preloaded.sku_metadata.get(sku_key, {})
    ...
    # ------------------------------------------------------------------
    criticality_tier: Optional[str] = sku_meta.get("criticality_tier")
    ...
    # ------------------------------------------------------------------
    planned_end_date = sku_meta.get("planned_end_date")   # datetime.date or None
    shelf_life_days  = sku_meta.get("shelf_life_days")    # int or None
    ...
    # Done Criterion: model_initialization_s9 row queued for every SKU.
    # ------------------------------------------------------------------
    try:
        batch_writer.queue(
